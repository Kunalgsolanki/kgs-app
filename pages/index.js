  ...
  <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
    <header className="flex justify-between items-center py-4 md:py-8">
      ...
      <nav className="hidden lg:flex gap-12">
        <div href="#" className="text-gray-600 hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">
    ...
    <Link href="/">
     Home
        ...
        <div  className="inline-flex items-center text-indigo-500 text-lg font-semibold gap-1">
        ...
        <div  className="text-gray-600 hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">Blog</div>

        </Link>

        <Link href="/contect">
        <div  className="text-gray-600 hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">Contect</div>
    ...
    <div className="w-full hidden lg:block bg-black border rounded-lg shadow-sm overflow-hidden">
      <div className="max-w-screen-lg flex items-center gap-8 p-8 mx-auto">
        ...
        <div className="w-1/3 border rounded-lg overflow-hidden">
          <div className="h-48 bg-black-100">
